...
var Dropdown = _interopRequire(require("./dropdown/dropdown"));
  ...
  _createClass(Dropdown, {
    ...
    render: {
      value: function render() {
        ...
        return React.createElement(
          "div",
          { className: classNames, ref: "menubox", onClick: this.onClickbox },
          React.createElement(
            "div",
            { className: "text" },
          ...
          React.createElement(Popup, { className: popUpClassNames, elts: this.props.items, onItemSelected: this.onItemSelectedHandler })
        );
      }
    }
  });
...
var Popupitem = _interopRequire(require("./popupitem"));
    ...
    render: {
      value: function render() {
        ...
        return React.createElement(
          ...
          this.props.elts.map(function (item) {
            return React.createElement(Popupitem, { key: item, onSelectedItem: _this.onClickhandler, itm: item });
          })
        );
      }
    }
...
var Popupitem = (function (_React$Component) {
	function Popupitem(props) {
		_classCallCheck(this, Popupitem);

		_get(Object.getPrototypeOf(Popupitem.prototype), "constructor", this).call(this, props);
		this.onClickPopupitem = this.onClickPopupitem.bind(this);
	}

	_inherits(Popupitem, _React$Component);

	_createClass(Popupitem, {
		onClickPopupitem: {
			value: function onClickPopupitem(e) {
		...
		render: {
			value: function render() {
				return React.createElement(
					"div",
					{ className: "item", onClick: this.onClickPopupitem },
					this.props.itm
				);
			}
		}
...
var RadioItems = (function (_React$Component) {
	function RadioItems(props) {
		_classCallCheck(this, RadioItems);

		_get(Object.getPrototypeOf(RadioItems.prototype), "constructor", this).call(this, props);
		this.onClickRadio = this.onClickRadio.bind(this);
	}

	_inherits(RadioItems, _React$Component);

	_createClass(RadioItems, {
		onClickRadio: {
			value: function onClickRadio() {
				this.props.onSelectedItem(this.props.itm);
			}
		},
		render: {
			value: function render() {
				return React.createElement(
					...
					React.createElement("input", { type: "radio", name: "sex", value: "male", onClick: this.onClickRadio }),
					React.createElement(
						"label",
						null,
						this.props.itm
...
var RadioItems = _interopRequire(require("./RadioItems"));

var Radiocomp = (function (_React$Component) {
	function Radiocomp(props) {
		_classCallCheck(this, Radiocomp);

		_get(Object.getPrototypeOf(Radiocomp.prototype), "constructor", this).call(this, props);
		this.state = { rval: "" };
		this.onItemSelectHandler = this.onItemSelectHandler.bind(this);
	}

	_inherits(Radiocomp, _React$Component);

	_createClass(Radiocomp, {
		onItemSelectHandler: {
			value: function onItemSelectHandler(val) {
			...
			value: function render() {
				...
				return React.createElement(
					...
					this.props.items.map(function (item) {
						return React.createElement(RadioItems, { key: item, itm: item, onSelectedItem: _this.onItemSelectHandler });
					})
				);
			}
		}
